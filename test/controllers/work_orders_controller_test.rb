...
class WorkOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_order" do
    assert_difference('WorkOrder.count') do
      post work_orders_url, params: { work_order: { date_end: @work_order.date_end, date_start: @work_order.date_start, details: @work_order.details, status: @work_order.status } }
    end
  ...
  test "should update work_order" do
    patch work_order_url(@work_order), params: { work_order: { date_end: @work_order.date_end, date_start: @work_order.date_start, details: @work_order.details, status: @work_order.status } }
